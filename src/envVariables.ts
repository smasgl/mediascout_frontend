export const envVariables = {
  ...
  API_USER_DELETE_URL: import.meta.env.VITE_API_USER_DELETE_URL as string,
  ...
  API_GET_YOUTUBEDATA_VIDEOS: import.meta.env
    .VITE_API_GET_YOUTUBEDATA_VIDEOS as string,
  API_GET_YOUTUBEVIDEO: import.meta.env.VITE_API_GET_YOUTUBEVIDEO as string,
  API_GET_YOUTUBEVIDEO_ALL: import.meta.env
    .VITE_API_GET_YOUTUBEVIDEO_ALL as string,
}
